...
export default class Service_template extends React.Component {
    constructor(props) {
        super(props)
        this.state={
          ...
          <div className="container px-0">
            <div className="row">
              <div className="col-md-5 service_page_title">
                ...
                <span>{this.state.slider_title} </span>
              </div>
          ...
          <div className="container  px-0">
            ...
            <div className="row my-5">
              ...
              <div className="col-md-4 service_provide_detail">
                <p className="service_provider_title">
                
                  {this.props.dataProp.service.service_provider_title} 
                ...
                <p className="service_rating">
                  ...
                  {this.props.dataProp.service.rating}

                </p>

                <p className="service_rate">Starts at &#8377;
                  {this.props.dataProp.service.starting_price}
                </p>
                ...
                <ul className="service_provider_points">
                  ...
                  {this.props.dataProp.service.points.map((s, i) => (  
                    <li>{s.p}</li> 
                  ))}  
              ...
              <div className="col-md-1">
                ...
                <img
                  src={this.props.dataProp.service.thumb_img}
                  alt=""
                />
